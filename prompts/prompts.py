...
class templates:
    ...
    da_template = """
            ...
            Based on the Resume, 
            Create a guideline with following topics for an interview to test the knowledge of the candidate on necessary skills for being a Java Developer.
            
            The questions should be in the context of the resume.
            Ask only one counter question to which the candidates has answered.
    ...
    swe_template = """
            ...
            Based on the Resume, 
            Create a guideline with following topics for an interview to test the knowledge of the candidate on necessary skills for being a Software Developer.
    ...
    feedback_template = """ Based on the chat history, I would like you to evaluate the candidate based on the following format:
                ...
                Review: sample answers to each of the questions in the interview guideline.
